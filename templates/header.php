    ...
    <header>
        <nav class="navbar navbar-expand navbar-light bg-light">
            <div class="nav navbar-nav">
                ...
                <a class="nav-item nav-link" href="<?php echo $url_base; ?>secciones/todolist">Lista de tareas</a>
                <a class="nav-item nav-link" href="<?php echo $url_base; ?>secciones/consultas">Consultas</a>
                <a class="nav-item nav-link" href="<?php echo $url_base; ?>secciones/pacientes">Pacientes</a>
