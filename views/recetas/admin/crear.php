    ...
    <div class="card-body">
        ...
        <form action="" enctype="multipart/form-data" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?php echo isset($errores['observaciones']) ? 'is-invalid' : ''; ?>" value="<?php echo isset($_POST['observaciones']) ? $_POST['observaciones'] : ''; ?>" name="observaciones" id="observaciones" aria-describedby="helpId" placeholder="Observaciones">
